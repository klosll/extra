...
from odoo.tools import (ustr, pycompat, formataddr, email_normalize, encapsulate_email, email_domain_extract)
...
# KLO. Esta función está en Odoo tools de v15.0 en adelante. Por eso se ha comentado en la parte import de este fichero.
# Como no está en la v14.0 se declara para que no de error.
# Esta es la función original de /opt/odoo15_klo/odoo/odoo/tools/mail.py.
...
class IrMailServer(models.Model):
    ...
    # KLO. _name = "ir.mail_server"
    _inherit = ['ir.mail_server']
    _description = 'Mail Server with from_filter'
    _order = 'sequence'
