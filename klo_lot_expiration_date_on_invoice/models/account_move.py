...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values_expiration_date(self):
        ...
        for lot, qty in qties_per_lot.items():
            ...
            l_expiration_date = self.env['stock.lot'].sudo().search([('id', '=', lot.id)])
            ...
            res.append({
                ...
                'lot_id': lot.id,
                'lot_expiration_date': l_expiration_date.expiration_date,
            })
